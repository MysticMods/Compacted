...
public class ModRecipes {
  ...
  public static void compacter(Block start, RegistryEntry<? extends Block> compressed, RegistryEntry<? extends Block> doubleCompressed, @Nullable Tag<Item> tag, RegistrateRecipeProvider p) {
    ...
    if (tag != null) {
      ...
      ShapelessRecipeBuilder.shapelessRecipe(compressed.get(), 1)
          ...
          .addIngredient(start)
          .addIngredient(start)
          .addCriterion("has_" + startName, p.hasItem(start))
          .build(p, compressedName + "_from_" + startName);
    }
  ...
  static {
    REGISTRATE.addDataGenerator(ProviderType.RECIPE, (ctx) -> {
          compacter(Blocks.ANDESITE, ModAdditionalBlocks.COMPACTED_ANDESITE, ModAdditionalBlocks.DOUBLE_COMPACTED_ANDESITE, null, ctx);
    compacter(Blocks.DIORITE, ModAdditionalBlocks.COMPACTED_DIORITE, ModAdditionalBlocks.DOUBLE_COMPACTED_DIORITE, null, ctx);
    compacter(Blocks.DIRT, ModAdditionalBlocks.COMPACTED_DIRT, ModAdditionalBlocks.DOUBLE_COMPACTED_DIRT, null, ctx);
    ...
    compacter(Blocks.GRANITE, ModAdditionalBlocks.COMPACTED_GRANITE, ModAdditionalBlocks.DOUBLE_COMPACTED_GRANITE, null, ctx);
    ...
    compacter(Blocks.PRISMARINE, ModAdditionalBlocks.COMPACTED_PRISMARINE, ModAdditionalBlocks.DOUBLE_COMPACTED_PRISMARINE, null, ctx);
    ...
    compacter(Blocks.SMOOTH_STONE, ModAdditionalBlocks.COMPACTED_SMOOTH_STONE, ModAdditionalBlocks.DOUBLE_COMPACTED_SMOOTH_STONE, null, ctx);
    compacter(Blocks.TERRACOTTA, ModAdditionalBlocks.COMPACTED_TERRACOTTA, ModAdditionalBlocks.DOUBLE_COMPACTED_TERRACOTTA, null, ctx);
    compacter(Blocks.STONE, ModAdditionalBlocks.COMPACTED_STONE, ModAdditionalBlocks.DOUBLE_COMPACTED_STONE, Tags.Items.STONE, ctx);
    compacter(Blocks.SOUL_SAND, ModAdditionalBlocks.COMPACTED_SOUL_SAND, ModAdditionalBlocks.DOUBLE_COMPACTED_SOUL_SAND, null, ctx);
    });
  }
