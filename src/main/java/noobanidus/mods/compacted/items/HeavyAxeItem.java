...
public class HeavyAxeItem extends ToolItem implements EffectiveToolItem, SizedToolItem {
  ...
  public static final Set<Material> EFFECTIVE_MATERIALS = ImmutableSet.of(Material.WOOD, Material.GOURD, Material.CACTUS, Material.PLANTS, Material.BAMBOO, Material.TALL_PLANTS);
